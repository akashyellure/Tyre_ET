({ 
    ...
    getDatafromParent:function(component,event,helper){
        ...
        var returnRejectValues = [];
        returnRejectValues.push({key: 'Return', value: 'Return'});
        returnRejectValues.push({key: 'Reject', value: 'Reject'});  
        component.set("v.returnRejectValues",returnRejectValues);
    ...
    getJobDetails : function(component, event, helper,Nextlineitem,nextWorkTracker) {
        ...
        action.setCallback(this, function(response) {
            if (response.getState() == "SUCCESS") {
                ...
                var act1 = component.get("c.getSideWallDetails");
                act1.setParams({
                    'recordId': component.get("v.recordId"),
                    'stageValue': 'Final Inspection',
                    'current_sequence': 7
                ...
                var act2 = component.get("c.getSideWallDetails");
                ...
                var action5 = component.get("c.getDesiredlengthSize");
                action5.setParams({ "JCId" : component.get("v.recordId") }); 
